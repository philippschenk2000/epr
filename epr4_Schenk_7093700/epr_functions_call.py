...
if option == '1':
    ...
    result = epr_functions.chaos_turtle(int(input('Enter the iterations/steps the turtle should do: ')), int(input('Enter start-X-coordinate: ')), int(input('Enter start-Y-coordinate: ')))
else:
