...
def main():
    ...
    df = pd.read_csv('/Users/psc/PycharmProjects/pythonProject/test_datasets/All_events_per_day_by_platform1.csv', delimiter=',')
    #df.rename(columns={'Jun 25 2022, 12:00AM - Sep 23 2022, 5:34PM': 'Events'}, inplace=True)
    date = df['Date']
    name = df['Name']
