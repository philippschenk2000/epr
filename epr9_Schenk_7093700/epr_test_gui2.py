...
class Ressource:
    ...
    def apply_effects(self, inhabitants_now, sentiment_now, bankroll_now):
        inhabitants_now += self.inhabitants_change
        sentiment_now += self.sentiment_change
        bankroll_now -= self.costs_fix
        profit_next_years = self.yearly_revenue * 10 - self.costs_fix
        return inhabitants_now, sentiment_now, bankroll_now, profit_next_years
...
def add_new_ressource(new_resource, resources_now, inhabitants_now, bankroll_now, sentiment_now):
    ...
    """
    resource_classes = {'church': Church, 'supermarket': Supermarket}
    if new_resource not in resources_now:
        ...
        resource = resource_classes[new_resource]()
